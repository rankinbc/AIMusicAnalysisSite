// P7 (bundle diet) — moved out of routes/_app/dev.kitchen-sink.tsx so the
// route file (auto code-split by TanStack Router) doesn't force this page
// into the entry chunk. The CSS module stays under routes/_app/ (it is not
// a route file itself, and moving it is unrelated to this diet).
...
import s from '../../routes/_app/dev.kitchen-sink.module.css';
