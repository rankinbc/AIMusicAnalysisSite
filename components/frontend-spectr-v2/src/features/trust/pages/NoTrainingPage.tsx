...
// P7 (bundle diet) — moved out of routes/trust.no-training.tsx so the route
// file (auto code-split by TanStack Router) doesn't force this page into
// the entry chunk. The route file re-exports PLEDGE_VERSION for callers
// that still resolve it from the route path.
